...
function init() {
  ...
  var valeur_deplacementCondyle = getDeplacement();
  var valeur_coupeFemorale = getCoupeFemorale();
  ...
  document.getElementById("valeur_coupeSagittale").innerHTML = valeur_coupeSagittale;
  document.getElementById("valeur_varus").innerHTML = valeur_varus;
  document.getElementById("valeur_embase").innerHTML = valeur_embase;
  document.getElementById("valeur_coupeFemoral").innerHTML = valeur_coupeFemorale;
   ...
   var light = new THREE.DirectionalLight(0xF5F5F5,1);
	...
	renderer.setSize(scene_globale.clientWidth , 600);
          ...
          if (mesh==null) {
             ...
             object.traverse( function ( child ) {
              if ( child instanceof THREE.Mesh ) {
                ...
                coupeFemorale(geometry,valeur_coupeFemorale); 
                ...
                loader2.load("img/Condyle_GT1.obj",function(object2) {
                     object2.traverse( function ( child ) {
                        if ( child instanceof THREE.Mesh ) {
                          ...
                          object2.position.x = 21+ valeur_deplacementCondyle; 
                          console.log("valeur_deplacementCondyle",valeur_deplacementCondyle);
